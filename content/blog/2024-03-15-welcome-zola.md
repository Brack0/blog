...
Why Zola then? I won't lie, I'm on the Rust hype train 🦀 (Rust mentioned BTW). A Rust engine was a secret requirement for this blog. I don't have to deal with `node`, `node_modules` and dependencies. Basic solution, straight to the point, multiple themes, all in one. This is exactly what I need.
...
Say goodbye to Nebulon. So Long, and Thanks for All the Fish 👋.
